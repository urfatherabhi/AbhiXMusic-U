...
async def cancelcmd(_, message):
    ...
    if chat_id in SPAM_CHATS:
        try:
            ...
            pass
        return await message.reply_text("**ᴛᴀɢɢɪɴɢ ᴘʀᴏᴄᴇss sᴜᴄᴄᴇssғᴜʟʟʏ sᴛᴏᴘᴘᴇᴅ! Nᴏᴡ Sᴀʏ ||PᴀPᴀ|| Tᴏ ||@URFather_ABHI||**")

    else:
        await message.reply_text("**Nᴏ Pʀᴏᴄᴇꜱꜱ Oɴɢᴏɪɴɢ! Nᴏᴡ Sᴀʏ ||PᴀPᴀ|| Tᴏ ||@URFather_ABHI||**")
        return
