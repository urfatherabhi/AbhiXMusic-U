...
TAGMES = [ " **𝐇𝐞𝐲 𝐁𝐚𝐛𝐲 𝐊𝐚𝐡𝐚 𝐇𝐨🤗🥱** ",
           ...
           " **𝐇𝐞𝐥𝐥𝐨 𝐉𝐢 𝐍𝐚𝐦𝐚𝐬𝐭𝐞😛** ",
           " **𝐇𝐞𝐥𝐥𝐨 𝐁𝐚𝐛𝐲 𝐊𝐤𝐫𝐡..?🤔** ",
           " **𝐃𝐨 𝐘𝐨𝐮 𝐊𝐧𝐨𝐰 𝐖𝐡𝐨 𝐈𝐬 𝐌𝐲 𝐎𝐰𝐧𝐞𝐫 [@URFather_ABHI].?** ",
...
async def mentionall(client, message):
    ...
    if message.reply_to_message and message.text:
        return await message.reply("/tagall  Tʏᴘᴇ Lɪᴋᴇ Tʜɪꜱ /Rᴇᴘʟʏ Aɴʏ Mᴇꜱꜱᴀɢᴇ Nᴇxᴛ Tɪᴍᴇ ...")
    elif message.text:
        mode = "text_on_cmd"
        msg = message.text
...
async def cancel_spam(client, message):
    if not message.chat.id in spam_chats:
        return await message.reply("Cᴜʀʀᴇɴᴛʟʏ I'ᴍ Nᴏᴛ..")
    is_admin = False
    try:
    ...
    if not is_admin:
        ...
        try:
            ...
            pass
        return await message.reply("🌷 AʙʜɪXᴍᴜꜱɪᴄ Tᴀɢ Aʟʟ Pʀᴏᴄᴇꜱꜱ Sᴛᴏᴘᴘᴇᴅ Nᴏᴡ Sᴀʏ ||PᴀPᴀ|| Tᴏ ||@URFather_ABHI|| 🎉")
