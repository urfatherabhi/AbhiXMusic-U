...
SHAYRI = [ "🌺**बहुत अच्छा लगता है तुझे सताना और फिर प्यार से तुझे मनाना।**🌺 \n\n**🥀Bahut aacha lagta hai tujhe satana Aur fir pyar se tujhe manana.🥀**",
           ...
           "🌺**Abhi ke dil mein bas tu hi rehti hai, teri ek muskaan se duniya jeeti hai.**🌺 \n\n**🥀Abhi ke dil mein bas tu hi rehti hai, teri ek muskaan se duniya jeeti hai.🥀**",
           "🌺**Abhi tera naam dil se nikalta nahi, tu meri wajah hai jo yeh dil dhadakta nahi.**🌺 \n\n**🥀Abhi tera naam dil se nikalta nahi, tu meri wajah hai jo yeh dil dhadakta nahi.🥀**",
           "🌺**Abhi ki zindagi ka har pal tera hai, tu saath ho toh har sapna mera hai.**🌺 \n\n**🥀Abhi ki zindagi ka har pal tera hai, tu saath ho toh har sapna mera hai.🥀**",
           "🌺**Abhi ke liye tu ek khubsurat khwab hai, dil se dil tak tera hi intezaar hai.**🌺 \n\n**🥀Abhi ke liye tu ek khubsurat khwab hai, dil se dil tak tera hi intezaar hai.🥀**",
           "🌺**Abhi ka yeh dil tujhpe fida hai, teri har ada pe yeh beqaraar hai.**🌺 \n\n**🥀Abhi ka yeh dil tujhpe fida hai, teri har ada pe yeh beqaraar hai.🥀**",
           "🌺**Teri aankhon mein doob jata hoon main, har pal tujhse hi pyar karta hoon main.**🌺 \n\n**🥀Teri aankhon mein doob jata hoon main, har pal tujhse hi pyar karta hoon main.🥀**",
           "🌺**Tujhse milke dil ko sukoon mila, har dhadkan mein tera hi naam sila.**🌺 \n\n**🥀Tujhse milke dil ko sukoon mila, har dhadkan mein tera hi naam sila.🥀**",
           "🌺**Chand sitaron se bhi pyara tera chehra, tujhse hi toh hai meri zindagi ka gehra.**🌺 \n\n**🥀Chand sitaron se bhi pyara tera chehra, tujhse hi toh hai meri zindagi ka gehra.🥀**",
           "🌺**Teri baaton mein hai ek jadoo sa, dil tujhse hi milta hai sukoon sa.**🌺 \n\n**🥀Teri baaton mein hai ek jadoo sa, dil tujhse hi milta hai sukoon sa.🥀**",
           "🌺**Har saans mein tera hi ehsaas hai, tu meri zindagi ka pehla pyar hai.**🌺 \n\n**🥀Har saans mein tera hi ehsaas hai, tu meri zindagi ka pehla pyar hai.🥀**",
]
...
async def mentionall(client, message):
    ...
    if message.chat.type == ChatType.PRIVATE:
        return await message.reply("Tʜɪꜱ Cᴏᴍᴍᴀɴᴅ Oɴʟʏ Fᴏʀ Gʀᴏᴜᴘꜱ...")
    ...
    try:
        ...
        if participant.status in (
            ...
            is_admin = True
    if not is_admin:
        return await message.reply("Yᴏᴜ Aʀᴇ Nᴏᴛ Aᴅᴍɪɴ Bᴀʙʏ, Oɴʟʏ Aᴅᴍɪɴꜱ Cᴀɴ...")

    if message.reply_to_message and message.text:
        return await message.reply("/shayaril  Tʏᴘᴇ Lɪᴋᴇ Tʜɪꜱ /Rᴇᴘʟʏ Aɴʏ Mᴇꜱꜱᴀɢᴇ Nᴇxᴛ Tɪᴍᴇ")
    elif message.text:
        mode = "text_on_cmd"
        msg = message.text
        ...
        if not msg:
            return await message.reply("/shayari  Tʏᴘᴇ Lɪᴋᴇ Tʜɪꜱ /Rᴇᴘʟʏ Aɴʏ Mᴇꜱꜱᴀɢᴇ Nᴇxᴛ Tɪᴍᴇ ...")
    else:
        return await message.reply("/shayari Tʏᴘᴇ Lɪᴋᴇ Tʜɪꜱ /Rᴇᴘʟʏ Aɴʏ Mᴇꜱꜱᴀɢᴇ Nᴇxᴛ Tɪᴍᴇ...")
    if chat_id in spam_chats:
        return await message.reply("Pʟᴇᴀꜱᴇ Aᴛ Fɪʀꜱᴛ Sᴛᴏᴘ Rᴜɴɴɪɴɢ Pʀᴏᴄᴇꜱꜱ...")
...
async def cancel_spam(client, message):
    if not message.chat.id in spam_chats:
        return await message.reply("Cᴜʀʀᴇɴᴛʟʏ I Aᴍ Nᴏᴛ Tᴀɢɢɪɴɢ...")
    is_admin = False
    try:
        ...
        if participant.status in (
            ...
            is_admin = True
    if not is_admin:
        return await message.reply("Yᴏᴜ Aʀᴇ Nᴏᴛ Aᴅᴍɪɴ Bᴀʙʏ Oɴʟʏ Aᴅᴍɪɴꜱ Cᴀɴ Tᴀɢ Mᴇᴍʙᴇʀꜱ Nᴏᴡ Sᴀʏ ||PᴀPᴀ|| Tᴏ ||@URFather_ABHI||.")
    else:
        try:
            spam_chats.remove(message.chat.id)
        except:
            pass
        return await message.reply("Sʜᴀʏᴀʀɪ Sᴛᴏᴘᴇᴅ Nᴏᴡ Sᴀʏ ||PᴀPᴀ|| Tᴏ ||@URFather_ABHI||")
